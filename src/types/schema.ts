...
export class FathomSwapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save FathomSwapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save FathomSwapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("FathomSwapFactory", id.toString(), this);
  }

  static load(id: string): FathomSwapFactory | null {
    return store.get("FathomSwapFactory", id) as FathomSwapFactory | null;
  }
...
export class FathomSwapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save FathomSwapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save FathomSwapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("FathomSwapDayData", id.toString(), this);
  }

  static load(id: string): FathomSwapDayData | null {
    return store.get("FathomSwapDayData", id) as FathomSwapDayData | null;
  }
